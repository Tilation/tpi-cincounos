...
public class PantallaEditorClases implements Pantalla {
    ...
    public PantallaEditorClases(GameServiceFactory gameServiceFactory, Pantalla pantallaAnterior, PantallaFactory pantallaFactory) {
