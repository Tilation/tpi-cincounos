...
public class PantallaEditorPartes implements Pantalla {
    ...
    public PantallaEditorPartes(GameServiceFactory gameServiceFactory, Pantalla pantallaAnterior, PantallaFactory pantallaFactory) {
