...
public class PantallaSeleccionEquipos implements Pantalla {
    ...
    public PantallaSeleccionEquipos(GameServiceFactory serviceFactory, PantallaFactory pantallaFactory) {
