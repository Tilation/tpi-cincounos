...
public class PantallaEditorCartas implements Pantalla {
    ...
    public PantallaEditorCartas(GameServiceFactory gameServiceFactory, Pantalla pantallaAnterior, PantallaFactory pantallaFactory) {
