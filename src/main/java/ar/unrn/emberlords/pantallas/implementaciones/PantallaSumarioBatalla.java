...
public class PantallaSumarioBatalla implements Pantalla {
    ...
    public PantallaSumarioBatalla(GameServiceFactory serviceFactory, PantallaFactory pantallaFactory) {
